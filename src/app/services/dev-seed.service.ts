  ...
  async ensureDevUserAndSeed(): Promise<void> {
    ...
    if (!statsSnap.exists()) {
      ...
      await setDoc(statsRef, {
        ...
        cardioScore: {
          totalCardioScore: 900,
        },
        strengthScore: {
          totalStrengthScore: 600,
        },
        totalScore: 1500,
        level: 7,
        region: {
    ...
    const dummyUsers = [
      {
        ...
        totalCardioScore: 2500,
        totalStrengthScore: 700,
        level: 10,
      },
      {
        userId: 'dummy_user_2',
        ...
        totalCardioScore: 1200,
        totalStrengthScore: 1600,
        level: 9,
      },
      {
        userId: 'dummy_user_3',
        ...
        totalCardioScore: 1700,
        totalStrengthScore: 200,
        level: 6,
      },
      {
        userId: 'dummy_user_4',
        ...
        totalCardioScore: 2100,
        totalStrengthScore: 2000,
        level: 12,
      },
      {
        userId: 'dummy_user_5',
        ...
        totalCardioScore: 800,
        totalStrengthScore: 1500,
        level: 8,
      },
      {
        userId: 'dummy_user_6',
        ...
        totalCardioScore: 2200,
        totalStrengthScore: 400,
        level: 9,
      },
      {
        userId: 'dummy_user_7',
      ...
      },
      {
        ...
        totalCardioScore: 1350,
        totalStrengthScore: 1350,
        level: 9,
      },
    ];
      ...
      try {
        ...
        await setDoc(
          ref,
          {
            ...
            cardioScore: {
              totalCardioScore: dummy.totalCardioScore,
            },
            strengthScore: {
              totalStrengthScore: dummy.totalStrengthScore,
            },
            totalScore: dummy.totalCardioScore + dummy.totalStrengthScore,
            level: dummy.level,
            region: dummy.region,
            last_updated_at: serverTimestamp(),
          },
