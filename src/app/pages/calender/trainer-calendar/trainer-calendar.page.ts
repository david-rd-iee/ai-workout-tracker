...
import { IonContent, IonDatetime, IonCard, IonCardHeader, IonCardTitle, IonCardContent, IonSpinner, IonButton } from '@ionic/angular/standalone';
...
export class TrainerCalendarPage implements OnInit {
  ...
  openWeeklyAvailability(): void {
    void this.router.navigateByUrl('/tabs/calender/trainer/availability');
  }
