...
import { TransactionService, Transaction } from '../../services/stripe/transaction.service';
...
export class HomePage implements OnInit {
  ...
  async loadUpcomingSessions() {
    ...
    try {
      ...
      this.noSessionsFound = sessions.length === 0;
      this.isLoadingSessions = false;
